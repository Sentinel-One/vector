...
- [x] Task 1: GCS decompression cap + framing max_length (OBE-10709) — `c5e9304` (private submodule, `2b175f603` parent)
- [x] Task 2: Logstash decompression + nested-C recursion guard (OBE-10712) — `b034a7fd7` + `637e03e5b` (tests)
